...
namespace Inchirieri_de_casete_video
{
    ...
    public class Movie
    {
        ...
        public Movie(string v_id, string v_name, decimal v_price, AgeRating v_ageRating, int v_rating, DateTime v_publishDate, int v_copies, Genre v_genre, string[] v_languages)
        {
            id = v_id;
            name = v_name;
            rating = v_rating;
